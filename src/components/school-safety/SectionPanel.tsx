...
import { SchoolSafetySection } from "@/data/school-safety-v2-data";
import { cn } from "@/lib/utils";
import { Lightbulb } from "lucide-react";

interface SectionPanelProps {
    section: SchoolSafetySection;
    index: number;
}
...
export const SectionPanel = ({ section, index }: SectionPanelProps) => {
    ...
    return (
        <section id={section.id} className={cn("py-8 relative overflow-hidden scroll-mt-10", bgClass)}>
            {/* Background Elements */}
            {index % 2 === 1 && (
                <>

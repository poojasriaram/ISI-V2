...
const appRoutes = [
  ...
  { path: "/integrated-services", element: <SalesInquiryPage /> },
  { path: "/integrated-services/thank-you", element: <ThankYouPage /> },
  { path: "/sales-inquiry", element: <Navigate to="/integrated-services" replace /> },
